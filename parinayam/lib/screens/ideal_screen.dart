...
class IdealScreen extends StatefulWidget {
  ...
  @override
  IdealScreenState createState() => IdealScreenState();
}

class IdealScreenState extends State<IdealScreen> {
  List<ParinayamModel> list = getIdealList();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget('Parinayama', center: true, titleTextStyle: boldTextStyle(size: 25)),
        ...
        child: Column(
          ...
          children: [
            ...
            AppButton(
              ...
              onTap: () {
                finish(context);
                // const MyHomePage(title: 'Parinayama',userId: userId).launch(context);
              },
              text: 'Continue',
